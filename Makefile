...
NAMESPACE=ibm-management-repo-operator

# Image URL to use all building/pushing image targets;
# Use your own docker registry and image name for dev/test by overridding the IMG and REGISTRY environment variable.
IMG ?= ibm-management-repo-operator
...
BASE_DIR := ibm-management-repo-operator
...
generate-csv: ## Generate CSV
	...
	@cp deploy/crds/operator.ibm.com_icpmanagement-repocharts_crd.yaml deploy/olm-management-repo/$(NAMESPACE)/$(CSV_VERSION)/
...
install: ## Install all resources (CR/CRD's, RBCA and Operator)
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_icpmanagement-repocharts_crd.yaml
	@echo ....... Applying RBAC .......
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_v1alpha1_icpmanagement-repochart_cr.yaml -n ${NAMESPACE}

uninstall: ## Uninstall all that all performed in the $ make install
	@echo ....... Uninstalling .......
	@echo ....... Deleting CR .......
	- kubectl delete -f deploy/crds/operator.ibm.com_v1alpha1_icpmanagement-repochart_cr.yaml -n ${NAMESPACE}
	@echo ....... Deleting Operator .......
	- kubectl delete -f deploy/operator.yaml -n ${NAMESPACE}
	@echo ....... Deleting CRDs.......
	- kubectl delete -f deploy/crds/operator.ibm.com_icpmanagement-repocharts_crd.yaml
