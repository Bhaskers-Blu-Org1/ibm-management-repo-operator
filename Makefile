...
install: ## Install all resources (CR/CRD's, RBCA and Operator)
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_mgmtrepos_crd.yaml
	@echo ....... Applying RBAC .......
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_v1alpha1_mgmtrepo_cr.yaml -n ${NAMESPACE}

uninstall: ## Uninstall all that all performed in the $ make install
	@echo ....... Uninstalling .......
	@echo ....... Deleting CR .......
	- kubectl delete -f deploy/crds/operator.ibm.com_v1alpha1_mgmtrepo_cr.yaml -n ${NAMESPACE}
